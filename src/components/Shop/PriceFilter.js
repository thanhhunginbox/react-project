...
function Test()
{
  function calculator (){
    var inputsRy = {
      ...
      thumbBorderWidth: 4,
      trackHeight: 4,
      theValue: [0, 500] // theValue[0] < theValue[1]
    };
    ...
    container.addEventListener("mousemove", function(evt) {
      ...
      if (isDragging0) {
        ...
        if (theValue0 < theValue1 - (thumbRealWidth / 2) &&
          ...
          outputs[0].innerHTML = "<p>" + theValue0 + "</p>"; //output min
        ...
        if (theValue1 > theValue0 + (thumbRealWidth / 2) &&
          ...
          outputs[1].innerHTML = "<p>" + theValue1 + "</p>"; //output max
  ...
  // calculator()
    ...
    return (
      <div className='filter priceFilter'>
        ...
        <div class="containertest filterContain">
